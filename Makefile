...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2024/10/23 20:08:16 by lwillis           #+#    #+#              #
#    Updated: 2024/10/23 20:09:07 by lwillis          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = srcs/main.c srcs/read_file.c srcs/str_utils.c srcs/parse_map.c srcs/map.c srcs/print_grid.c srcs/obstacles_grid.c srcs/test_square.c srcs/print_solved_map.c srcs/parse_legend.c
